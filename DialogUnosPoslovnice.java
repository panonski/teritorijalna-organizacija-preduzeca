...
public class DialogUnosPoslovnice extends JDialog {
  ...
  public DialogUnosPoslovnice(Frame frame, String title, boolean modal) {
  ...
  public DialogUnosPoslovnice() {
	...
	void jbInit() throws Exception {
		...
		jLabel1.setText("Unos nove poslovnice");
	...
	void bPotvrdi_actionPerformed(ActionEvent e) {
		...
		String res = DBF.insertPoslovnica((Integer)((Vector)IDPbrojevi.elementAt(cbIDP.getSelectedIndex())).elementAt(0),
		...
		if(res!=null) {
			...
			JOptionPane.showMessageDialog(null,"Poslovnica je uspesno uneta!");
			dispose();
		}
	}
}
