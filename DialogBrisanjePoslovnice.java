...
public class DialogBrisanjePoslovnice extends JDialog {
	...
	public DialogBrisanjePoslovnice(Frame frame, String title, boolean modal) {
	...
	public DialogBrisanjePoslovnice() {
		this(null, "", false);
	}
	...
	void jbInit() throws Exception {
		...
		jLabel1.setText("Brisanje postoje\u0107e poslovnice");
		...
		jLabel4.setText("Identifikacioni broj poslovnice:");
		...
		jPanel2.add(jLabel3,  new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
		      ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(20, 0, 2, 0), 0, 0));
		jPanel2.add(txtIDF,   new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
		      ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(20, 10, 2, 10), 0, 0));
		...
		jPanel2.add(txtIDPOS,   new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0
	...
	void bPotvrdi_actionPerformed(ActionEvent e) {
		...
		String res = DBF.deletePoslovnica((Integer)((Vector)IDPbrojevi.elementAt(cbIDP.getSelectedIndex())).elementAt(0),
		...
		if (res!=null) {
			...
			JOptionPane.showMessageDialog(null,"Poslovnica je uspe�no obrisana");
			txtIDPOS.grabFocus();
			txtIDPOS.setSelectionStart(0);
			txtIDPOS.setSelectionEnd(txtIDPOS.getText().length());
		}
	}
}
